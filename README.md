...
- The device must have up-to-date jailbreak bootstrap. This is to ensure that the device has the necessary tools and configurations to download the files from GitHub. The user should add `https://repo.bingner.com` repository and upgrade the packages if they are on iOS 10 or lower.
